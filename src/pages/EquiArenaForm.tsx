    ...
    const save = useCallback(
        async (download: boolean) => {
            ...
            try {
                ...
                if (download) {
                    const { blob, ensayoId: returnedId, filename } = await saveAndDownloadEquiArenaExcel(payload, editingEnsayoId ?? undefined)
                    ...
                    const saved = await saveEquiArenaEnsayo(payload, editingEnsayoId ?? undefined)
                    savedId = saved.id
                }
